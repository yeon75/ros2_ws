...
#ifndef INTERFACE_EXAMPLE__SRV__DETAIL__ADD_TWO_INT__FUNCTIONS_H_
#define INTERFACE_EXAMPLE__SRV__DETAIL__ADD_TWO_INT__FUNCTIONS_H_
...
/// Initialize srv/AddTwoInt message.
/**
...
/// Finalize srv/AddTwoInt message.
/**
...
/// Create srv/AddTwoInt message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interface_example__srv__AddTwoInt_Request__init().
...
/// Destroy srv/AddTwoInt message.
/**
 * It calls
 * interface_example__srv__AddTwoInt_Request__fini()
...
/// Check for srv/AddTwoInt message equality.
/**
...
/// Initialize array of srv/AddTwoInt messages.
/**
...
/// Finalize array of srv/AddTwoInt messages.
/**
 * It calls
 * interface_example__srv__AddTwoInt_Request__fini()
...
/// Create array of srv/AddTwoInt messages.
/**
 * It allocates the memory for the array and calls
 * interface_example__srv__AddTwoInt_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AddTwoInt messages.
/**
 * It calls
 * interface_example__srv__AddTwoInt_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AddTwoInt message array equality.
/**
...
/// Copy an array of srv/AddTwoInt messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interface_example__srv__AddTwoInt_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interface_example
...
/**
 * It calls
 * interface_example__srv__AddTwoInt_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_interface_example
...
/**
 * It allocates the memory for the array and calls
 * interface_example__srv__AddTwoInt_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interface_example
...
/**
 * It calls
 * interface_example__srv__AddTwoInt_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // INTERFACE_EXAMPLE__SRV__DETAIL__ADD_TWO_INT__FUNCTIONS_H_
