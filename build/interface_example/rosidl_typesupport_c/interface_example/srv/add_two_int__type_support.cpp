...
static const _AddTwoInt_Request_type_support_symbol_names_t _AddTwoInt_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface_example, srv, AddTwoInt_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interface_example, srv, AddTwoInt_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interface_example, srv, AddTwoInt_Request)() {
  return &::interface_example::srv::rosidl_typesupport_c::AddTwoInt_Request_message_type_support_handle;
}
...
static const _AddTwoInt_Response_type_support_symbol_names_t _AddTwoInt_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface_example, srv, AddTwoInt_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interface_example, srv, AddTwoInt_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interface_example, srv, AddTwoInt_Response)() {
  return &::interface_example::srv::rosidl_typesupport_c::AddTwoInt_Response_message_type_support_handle;
}
...
static const _AddTwoInt_type_support_symbol_names_t _AddTwoInt_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface_example, srv, AddTwoInt)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interface_example, srv, AddTwoInt)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, interface_example, srv, AddTwoInt)() {
  return &::interface_example::srv::rosidl_typesupport_c::AddTwoInt_service_type_support_handle;
}
