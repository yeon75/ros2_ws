...
static const _ArithmeticOperator_Request_type_support_symbol_names_t _ArithmeticOperator_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface_example, srv, ArithmeticOperator_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interface_example, srv, ArithmeticOperator_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interface_example, srv, ArithmeticOperator_Request)() {
  return &::interface_example::srv::rosidl_typesupport_c::ArithmeticOperator_Request_message_type_support_handle;
}
...
static const _ArithmeticOperator_Response_type_support_symbol_names_t _ArithmeticOperator_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface_example, srv, ArithmeticOperator_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interface_example, srv, ArithmeticOperator_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, interface_example, srv, ArithmeticOperator_Response)() {
  return &::interface_example::srv::rosidl_typesupport_c::ArithmeticOperator_Response_message_type_support_handle;
}
...
static const _ArithmeticOperator_type_support_symbol_names_t _ArithmeticOperator_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface_example, srv, ArithmeticOperator)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interface_example, srv, ArithmeticOperator)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, interface_example, srv, ArithmeticOperator)() {
  return &::interface_example::srv::rosidl_typesupport_c::ArithmeticOperator_service_type_support_handle;
}
